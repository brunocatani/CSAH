...
require_token("${FILMIC_SHADER_GENERATOR}"
  "ImageSpace[027]" "the exact packed FXP family")
require_token("${FILMIC_SHADER_GENERATOR}"
  "f1bfa042d52062c4aedfd612bbf4799d" "the native DXBC identity")
...
require_token("${FILMIC_RUNTIME_SOURCE}"
  ...
  "the exact native bytecode length")
require_token("${FILMIC_RUNTIME_SOURCE}"
  "generated::kPixelShader" "the generated replacement asset")
require_token("${FILMIC_RUNTIME_SOURCE}"
