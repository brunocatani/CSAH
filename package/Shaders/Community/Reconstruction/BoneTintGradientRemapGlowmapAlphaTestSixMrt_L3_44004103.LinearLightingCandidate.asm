...
sqrt r0.z, r0.z
movc r1.z, v9.x, r0.z, -r0.z
dp3 r0.z, r2.xyzx, r1.xyzx
min r2.z, r0.z, l(0.000000)
dp3 r0.z, v1.xyzx, v1.xyzx
rsq r0.z, r0.z
mul r5.xyz, r0.zzzz, v1.xyzx
dp3 r2.x, r5.xyzx, r1.xyzx
...
add r0.z, -cb2[7].z, cb2[7].w
lt r0.w, cb2[7].w, l(0.000000)
movc r0.w, r0.w, l(0), cb12[50].x
mad r0.z, r0.w, r0.z, cb2[7].z
mul r0.w, r0.w, cb2[7].w
