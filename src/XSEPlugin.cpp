    ...
    const F4SE::LoadInterface* a_f4se) noexcept
{
    try {
        ...
        community_shaders::logging::info(
            ...
            iblSettings.freezePublishedCube,
            iblSettings.geometricLookupNormal,
