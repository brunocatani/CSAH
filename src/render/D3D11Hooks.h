...
namespace community_shaders::render
{
    ...
    // Observes a displaced immediate-context vtable twice before restoring
    // the isolated shadow. A downstream chain that still reaches this plugin
    // is preserved without mutation.
